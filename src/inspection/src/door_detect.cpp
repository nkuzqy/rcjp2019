    ...
    void pclCallback (const sensor_msgs::PointCloud2& msg)
    {
        ...
        if (if_detect)
        {
            if (door_opened && step>=50)
		    {
		        ...
		        msg.mission_type = "detect";
		        msg.result = "door_open";
...
public:
    int run (int argc, char** argv)
    {
        ...
        nh.param<std::string> ("path_to_save_image"         , path_to_save_image         , "/home/nvidia/rcjp_ws/src/inspection");
