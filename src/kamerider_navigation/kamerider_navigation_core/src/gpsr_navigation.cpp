...
private:
    ...
    //定义不同房间的坐标点
    location_pose  pick_and_place_start;
    location_pose  known;
    location_pose  trash_bin;
    location_pose  avoid_that_start;
    location_pose  what_did_you_say_start;
    location_pose  exit;
    ...
    {
        ifstream waypoints;
        waypoints.open("/home/kamerider/rcjp_navigation_ws/src/kamerider_navigation/kamerider_navigation_core/gpsr_waypoints.txt", ios::out);
        string data, line;
        vector<string> str; 
