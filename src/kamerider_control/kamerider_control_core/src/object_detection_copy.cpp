...
#include <kamerider_control_msgs/ObjectPosition.h>
...
private:
    ...
    void get_object_position()
    {
        ...
        else
        {
            ...
            kamerider_control_msgs::ObjectPosition pos;
...
public:
    int run (int argc, char** argv)
    {
        ...
        control_sub = nh.subscribe("/control_to_arm", 1, &object_detection::controlCallback, this);
        
        obj_pub = nh.advertise<kamerider_control_msgs::ObjectPosition>(pub_object_pos_topic_name, 1);
