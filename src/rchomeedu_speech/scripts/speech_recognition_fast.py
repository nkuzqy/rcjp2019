...
class speech_recognition_baidu():
    def __init__(self):
        ...
        self.audio_folder = "/home/kamerider/rcjp_navigation_ws/src/rchomeedu_speech/sounds/gpsr_record/"
    ...
    def get_params(self):
        ...
        self.pub_recognition_result_topic_name = rospy.get_param("pub_recognition_result_topic_name", "/baidu_output")
